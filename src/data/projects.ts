...
export const projects = {
	...
	items: [
		...
		},
		{
			...
			product: 'Hexagrow',
			pictures: [],
			description: 'A solo hex-grid prototype about growing territory, shaping patterns, and making small strategic choices.',
			tools: ['Hex Grid', 'Puzzle', 'Solo'],
			projectTags: {
				format: ['Game', 'Prototype'],
				platform: ['PC'],
		...
		},
		{
			id: 'christmas-game',
			companyId: 'solo',
			product: 'Christmas Game',
			pictures: [],
			description: 'A festive solo game prototype built around quick play, seasonal ideas, and light group-friendly moments.',
			tools: ['Festive', 'Prototype', 'Solo'],
			projectTags: {
				format: ['Game', 'Prototype'],
				platform: ['PC'],
		...
		{
			id: 'amazing-maze-game',
			companyId: 'daytime-devs',
			product: 'Amazing Maze Game',
			pictures: [],
			description: 'A Daytime Devs maze prototype built around readable layouts, route planning, and puzzle-like navigation.',
			tools: ['Maze', 'Prototype', 'Daytime Devs'],
			projectTags: {
				format: ['Game', 'Prototype'],
				platform: ['PC'],
				specialty: ['Puzzle'],
		...
		{
			id: 'mercenary-madness',
			companyId: 'solo',
			product: 'Mercenary Madness',
			pictures: [],
			description: '',
			tools: [],
			projectTags: {
		...
		},
		{
			...
			description:
				'A released Age of Mythology: The Titans custom map series combining BETA, EASY, and HARD versions of a shop-and-siege scenario for solo or LAN play.',
